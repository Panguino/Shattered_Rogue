...
Materials (parameterized, no unique textures): `/Game/Materials/Environment/M_SpaceSky`, `M_SpaceSun`, `M_SpaceSunGlow`, `M_SpacePlanet`, `M_SpaceAsteroid`, `M_SpaceRing`. There is deliberately no dust material: distant gas belongs to the sky shader and near gas has no geometry.
