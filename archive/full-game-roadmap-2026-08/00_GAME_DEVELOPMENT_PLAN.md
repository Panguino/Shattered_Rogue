...
| Document | Covers |
| --- | --- |
| [Ship Prompts](art/ship_prompts.md) | 30 ChatGPT one-shots (Ace style lock, empty gold hardpoints) |
| [ships.json](art/ships.json) | Structured prompt data for the wiki |

**HTML wiki:** open [wiki/dist/index.html](wiki/dist/index.html)
...
| Document                                                            | Covers                                                           |
| ------------------------------------------------------------------- | ---------------------------------------------------------------- |
| [AI Toolchain](technical/ai_toolchain.md)                           | Code gen, Tripo triangle targets, Unreal MCP, concept art        |
| [Architecture](technical/architecture.md)                           | UE 5.8 C++/Blueprint strategy, MCP, networking, plugin structure |
...
| Document                                                                          | Covers                            |
| --------------------------------------------------------------------------------- | --------------------------------- |
| [Roguelike Genre Research](research/01_ROGUELIKE_GENRE_RESEARCH.md) | Genre analysis, mechanics catalog, market |
| [Engine MCP / AI Integration](research/engine_mcp_ai_integration.md) | UE vs Unity vs Godot MCP (2026-08) — stay on UE 5.8 |
...
- [ ] **→ Next: Phase 1 — UE 5.8 project setup + Unreal MCP**
...
>
> 1. Set up UE 5.8 project with C++ module structure + Unreal MCP (Phase 1.1)
...
| --------------- | ----------------------------------------------------------------- | ---------- |
| Engine          | Unreal Engine 5.8 (C++ primary). Official Unreal MCP + Cursor. Stay; do not switch to Unity/Godot. | 2026-08-19 |
| Combo slot mix  | Named combo sets W/M/S (still 10). Hull = size + mechanic; profession = unique 3D kit. | 2026-08-19 |
| Player ship tris | Ace LOD0 **6,000** triangles (ok 4k–8k). Tripo Smart Mesh, triangle topology. | 2026-08-19 |
